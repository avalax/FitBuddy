...
public class EditExerciseViewHelperTest {
    ...
    public void shouldReturnMaxRepsAsTitle() throws Exception {
        ...
        assertThat(service.repsFrom(set)).isEqualTo("12 reps");
        assertThat(service.repsValue(set)).isEqualTo("12");
    }

    @Test
    public void noWeight_shouldReturnDashAsSubtitle() throws Exception {
        Set set = aSet().build();
        assertThat(service.weightFrom(set)).isEqualTo("no weight");
        assertThat(service.weightValue(set)).isEqualTo("0");
    }
    ...
    public void doubleAsWeight_shouldReturnWeightAsSubtitle() throws Exception {
        ...
        assertThat(service.weightFrom(set)).isEqualTo("42.625 kg");
        assertThat(service.weightValue(set)).isEqualTo("42.625");
    }

    @Test
    public void integerAsWeight_shouldReturnWeightAsSubtitle() throws Exception {
        Set set = aSet().withWeight(42).build();
        assertThat(service.weightFrom(set)).isEqualTo("42 kg");
        assertThat(service.weightValue(set)).isEqualTo("42");
    }
}